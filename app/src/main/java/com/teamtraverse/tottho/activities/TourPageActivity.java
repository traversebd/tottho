...
public class TourPageActivity extends AppCompatActivity {
    ...
    private void bindUiWithComponents() {
        ...
        layouts = new int[]{
                R.layout.education_tour_page,
                R.layout.events_tour_page,
                R.layout.government_tour_page,
                R.layout.scholarship_portal_tour_page};
        ...
        findViewById(R.id.nextBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (current < layouts.length) {
                    ...
                    startActivity(new Intent(TourPageActivity.this, MainActivity.class));
                }
            }
        });
    }
